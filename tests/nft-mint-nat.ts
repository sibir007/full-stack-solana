...
import { CreateTokenArgs, MintToArgs, NftMinterInstruction } from './nft-mint-nat-instructions.ts';
...
describe('NFT Minter', () => {
  ...
  const program = createKeypairFromFile('./target/deploy/nft_mint_nat-keypair.json');
